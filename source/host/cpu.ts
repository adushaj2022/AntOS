  ...
  export class Cpu {
    ...
    public decode(): void {
      ...
      if (this.oneStep) {
        ...
        this.memory.setMDR(
          this.memory.readIntermediate(this.program_counter++)
        );
        ...
        if (instr === 0xa9) {
          ...
          /*
                      branches
                  */
          let twos_comp = Utils.twos_comp(this.memory.getMDR());
          if (this.zFlag) {
    ...
    public execute(): void {
      ...
      if (this.process_String) {
        ...
        _Console.lwPutText(
          Ascii.fromCharCode(this.memory.readIntermediate(this.memory.getMAR()))
        ); // print char
